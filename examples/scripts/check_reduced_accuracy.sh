...
#
extraext="_ref"
fmt_energy="%.8f"      # Format used for energy conversion
fmt_eigenenergy="%.7f" # Format used for eigenstate energy conversion
fmt_population="%.7f"  # Format used for population conversion
fmt_dipole="%.7f"      # Format used for dipole conversion
fmt_pes="%.6f"         # Format used for photoelectron amplitudes
#
